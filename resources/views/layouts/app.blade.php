                ...
                <nav class="flex-1">
                    <div class="space-y-2">
                        ...
                        <a href="{{ route('assessments.index') }}"
                            ...
                            <div class="menu-label show">
                                <span
                                    class="font-medium transition-colors {{ request()->routeIs('assessments.*') ? 'text-blue-600' : 'text-gray-700 group-hover:text-gray-900' }}">Assessment
                                    Tests</span>
                        ...
                        <a href="{{ route('jobseekers.index') }}"
                            class="menu-item group flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-200 hover:bg-gray-50">
                            <div
                                class="w-10 h-10 rounded-lg flex items-center justify-center transition-colors flex-shrink-0 bg-gray-100 group-hover:bg-blue-50">
                                <svg class="w-5 h-5 transition-colors text-gray-600 group-hover:text-blue-500"
                                    fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="menu-label show">
                                <span
                                    class="font-medium transition-colors text-gray-700 group-hover:text-gray-900">Candidates</span>
